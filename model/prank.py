...
class Graph:
    ...
    graph_path = 'data/prank_model/prank.graph'
    ...
    def _gen_user_graph(cls, user_id):
        ...
        item_ids = list(set(cls.frame[cls.frame['user'] == user_id]['item']))
    ...
    def _gen_item_graph(cls, item_id):
        ...
        user_ids = list(set(cls.frame[cls.frame['item'] == item_id]['user']))
...
class PersonalRank:
    ...
    def save(self, user_id):
        f = open('data/prank_model/prank_{}.model'.format(user_id), 'wb')
