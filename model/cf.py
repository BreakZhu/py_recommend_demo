...
class UserCf:
    ...
    def _get_candidates_items(self, target_user_id):
        ...
        """
        target_user_movies = set(self.frame[self.frame['user'] == target_user_id]['item'])
        other_user_movies = set(self.frame[self.frame['user'] != target_user_id]['item'])
    ...
    def _get_top_n_items(self, top_n_users, candidates_movies, top_n):
        ...
        """
        top_n_user_data = [self.frame[self.frame['user'] == k] for k, _ in top_n_users]
        interest_list = []
